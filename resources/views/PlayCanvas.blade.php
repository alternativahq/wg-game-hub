...
<html lang="en-us">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Unity WebGL Player | wodoland-mini-fps</title>
  ...
  <body>
    <div id="unity-container" class="unity-desktop">
      ...
      <div id="unity-footer">
        <div id="unity-webgl-logo"></div>
        <div id="unity-fullscreen-button"></div>
        <div id="unity-build-title">wodoland-mini-fps</div>
      </div>
    </div>
    <script>
      var container = document.querySelector("#unity-container");
      ...
      var config = {
        ...
        codeUrl: buildUrl + "/webgl.wasm.gz",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Wodo Platform",
        productName: "wodoland-mini-fps",
        productVersion: "0.1",
        showBanner: unityShowBanner,
      };
      ...
      script.onload = () => {
        createUnityInstance(canvas, config, (progress) => {
          ...
          loadingBar.style.display = "none";
          unityInstance.SendMessage("JavascriptTalk","setSession",qs.sessionName);
          fullscreenButton.onclick = () => {
            unityInstance.SetFullscreen(1);
          };
        }).catch((message) => {
