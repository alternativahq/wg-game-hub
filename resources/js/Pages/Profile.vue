...
<template>
    <div>
        <BorderedContainer class="mb-9 bg-wgh-gray-1.5">
            <div
                class="flex flex-col justify-between rounded-lg bg-white p-6 md:flex-row"
            >
                <div
                    class="flex flex-row items-start space-x-5 lg:items-center"
                >
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <p
                            class="font-inter text-sm font-normal text-wgh-gray-4"
                        >
                ...
                <BorderedContainer class="bg-wgh-gray-1.5">
                    <div class="rounded-lg bg-white p-6">
                        <BorderedContainer class="mb-4 bg-wgh-gray-0.5">
                            <div
                                class="relative mx-auto flex flex-col justify-around gap-x-4 rounded-lg p-4 md:flex-row"
                            >
                                <div
                                    class="flex basis-1/3 cursor-pointer flex-row items-center space-x-4 rounded-lg p-3 transition-all duration-100"
                                    :class="{
                                        'bg-wgh-pink-1':
                                            activeTransactionNetwork ===
                                            'banano',
                                    }"
                                    @click.prevent="
