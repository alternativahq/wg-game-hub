...
<template>
    ...
    <div>
        <BorderedContainer class="mb-10 bg-wgh-purple-3">
            <div
                class="flex flex-col justify-between rounded-lg bg-wgh-purple-2 p-7 md:flex-row"
            >
                ...
                <div
                    class="flex shrink-0 flex-row divide-x divide-wgh-gray-0.5"
                >
                    <div
            ...
            >
                <div class="h-full max-w-3xl rounded-lg bg-white p-6">
                    ...
                    <div class="mb-4 flex flex-row justify-between">
                        ...
                        <div
                            class="text-bold font-grota text-base text-wgh-gray-6"
                        >
                            <span
                            ...
                            <div class="w-full content-center">
                                <span
                                    ...
                                    v-if="
                                        settings.isThereActiveLobbySession() &&
                                        gameLobby.id ===
                                            settings.getActiveGameLobbySession()
                                                .id
                                    "
                                    >Rejoin Lobby</span
                                >
